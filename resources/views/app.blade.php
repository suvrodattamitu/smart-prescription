...
<body>
    ...
    <div class="left-sidebar-pro" id="smart-prescription">
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><router-link to="/all-tests" title="Dashboard v.1"><span class="mini-sub-pro">All Test</span></router-link></li>
                                <li><router-link to="/add-test" title="Dashboard v.2"><span class="mini-sub-pro">Add Test</span></router-link></li>
