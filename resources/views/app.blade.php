                        ...
                        <ul class="metismenu" id="menu1">
                            ...
                            <li>
                                ...
                                <ul class="submenu-angle form-mini-nb-dp" aria-expanded="false">
                                    <li>
                                        <a title="Basic Form Elements" href="basic-form-element.html"><span class="mini-sub-pro">Bc Form Elements</span></a>
                                    </li>
                                    <li>
                                        <a title="Advance Form Elements" href="advance-form-element.html"><span class="mini-sub-pro">Ad Form Elements</span></a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav">
                                            ...
                                            <li class="nav-item dropdown res-dis-nn">
                                                ...
                                                Project <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span>
                                                </a>
